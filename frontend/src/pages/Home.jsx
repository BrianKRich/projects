...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Achievement banner */}
      <div className="bg-[#FFD700] rounded-xl text-center py-3 sm:py-4 px-3 sm:px-6 mb-8">
        <p className="text-[#4D007B] font-bold text-base sm:text-lg">
          Both Teams FOUR-PEAT Champions (2022–2025)
        </p>
      </div>

      {/* Quick stats */}
      <section aria-label="Team statistics" aria-live="polite" aria-atomic="true">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        {[
          ...
          <div key={label} className="bg-white rounded-xl shadow p-4 sm:p-6 text-center">
